...
namespace HotelManagementSystem_CoreMvc.Controllers
{
    public class MenuModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MenuHelperModelId,RollId,RollIdText")] MenuModel menuModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MenuHelperModelId,RollId,RollIdText")] MenuModel menuModel)
        {
            if (id != menuModel.Id)
            {
                return NotFound();

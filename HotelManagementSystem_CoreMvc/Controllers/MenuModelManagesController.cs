...
namespace HotelManagementSystem_CoreMvc.Controllers
{
    public class MenuModelManagesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MenuModelId,Retrive,Insert,Update,Delete")] MenuModelManage menuModelManage)
        {
            if (id != menuModelManage.Id)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!MenuModelManageExists(menuModelManage.Id))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.MenuModelManage.Any(e => e.Id == id);
        }
    }
}
